    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.CharField(help_text=b'e.g. "Steering compass" or "with radio mounted on binnacle"', max_length=80, verbose_name=b'Note', blank=True)),
                ...
                ('unlocked', models.DateTimeField(null=True, editable=False, blank=True)),
